...
- **Database Migration Safety**: For any Prisma schema or database migration tasks, you MUST strictly read and follow the [prisma-migration-safety.md](../../.agents/rules/prisma-migration-safety.md) rules. Direct database mutation on production is strictly forbidden for agents.
