...
## Overview
- Date: 2026-06-29
- Description: Xác minh luồng demo từ student intake đến admin/supporter consumption.
- Priority: High
...
- Có dữ liệu case mẫu synthetic nhưng đủ thật để thuyết phục audience.
...
<!-- Updated: Validation Session 1 - synthetic realistic demo data -->

## Architecture
- Verification and presentation layer only.
- Có thể dùng local run/manual walkthrough nếu cần.
...
1. Chuẩn bị một hồ sơ demo mẫu synthetic nhưng sát pain thật EXE101/FPT.
...
4. Kiểm tra discussion/chat có đọc được, gửi được, polling ổn, và wording đủ rõ để dùng trong demo.
...
8. Viết demo script cuối cùng: nói gì ở mỗi màn, highlight giá trị gì.
<!-- Updated: Validation Session 1 - synthetic realistic case package -->
...
<!-- Updated: Validation Session 1 - demo data preparation clarified -->
...
- Risk chính là thiếu dữ liệu demo mẫu đủ thật hoặc flow handoff chưa khớp.

## Security Considerations
- Dùng dữ liệu demo an toàn, không lộ thông tin nhạy cảm thật của sinh viên.
- Nếu dùng Drive demo, bảo đảm quyền chia sẻ phù hợp môi trường demo.

## Next steps
- Sau verify, nếu còn thời gian thì chọn các polish item nhỏ. Không mở rộng scope lớn.
